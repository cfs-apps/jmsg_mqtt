...
#define CFG_TEST_CHILD_NAME          TEST_CHILD_NAME
#define CFG_TEST_CHILD_STACK_SIZE    TEST_CHILD_STACK_SIZE
#define CFG_TEST_CHILD_PRIORITY      TEST_CHILD_PRIORITY
#define CFG_TEST_CHILD_DELAY         TEST_CHILD_DELAY
...
#define APP_CONFIG(XX) \
   ...
   XX(TEST_CHILD_NAME,char*) \
   XX(TEST_CHILD_STACK_SIZE,uint32) \
   XX(TEST_CHILD_PRIORITY,uint32) \
   XX(TEST_CHILD_DELAY,uint32)
